...
-- Create polytool database (may already exist via CLICKHOUSE_DB env)
CREATE DATABASE IF NOT EXISTS polytool;
...
-- Grant SELECT access on polytool database to grafana_ro
GRANT SELECT ON polytool.* TO grafana_ro;
