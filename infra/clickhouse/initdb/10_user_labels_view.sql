...
DROP VIEW IF EXISTS polytool.users_grafana_dropdown;
...
CREATE VIEW polytool.users_grafana_dropdown AS
WITH
...
GRANT SELECT ON polytool.users_grafana_dropdown TO grafana_ro;
