...
```bash
cp "D:/Coding Projects/Polymarket/PolyTool/.claude/get-shit-done/USER-PROFILE.md" "D:/Coding Projects/Polymarket/PolyTool/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="D:/Coding Projects/Polymarket/PolyTool/.claude/USER-PROFILE.backup.md"
```
