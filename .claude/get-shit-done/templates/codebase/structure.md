...
- Usage: Reference from command with `@D:/Coding Projects/Polymarket/PolyTool/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Coding Projects/Polymarket/PolyTool/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Coding Projects/Polymarket/PolyTool/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
