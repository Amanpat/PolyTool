...
- **Global scope**: `D:/Coding Projects/Polymarket/PolyTool/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Coding Projects/Polymarket/PolyTool/.claude/notes/`)
...
2. Glob `D:/Coding Projects/Polymarket/PolyTool/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/Coding Projects/Polymarket/PolyTool/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Coding Projects/Polymarket/PolyTool/.claude/notes/` — works in any directory
