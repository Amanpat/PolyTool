...
references:
  - "2026-05-23-session-research-captured-vault-redesign (C-004: file not yet exported from Claude Desktop)"
related:
  - "claude-memory/decisions/2026-05-23-chroma-vs-obsidian-rag (missing: decision doc not yet created)"
depends_on: []
---
