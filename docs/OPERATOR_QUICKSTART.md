...
For full RAG details: `docs/LOCAL_RAG_WORKFLOW.md`
...
For full SimTrader documentation: `docs/README_SIMTRADER.md`
...
| RAG workflow details | `docs/LOCAL_RAG_WORKFLOW.md` |
| LLM bundle workflow | `docs/LLM_BUNDLE_WORKFLOW.md` |
