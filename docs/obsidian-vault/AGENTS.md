---
title: Vault Operating Rules (All Agents)
type: reference
status: active
source_zone: claude_memory
last_updated: 2026-05-23
lifecycle: reviewed
aliases: [AGENTS, Agent Rules]
supersedes: claude-memory/archive/AGENT
---

# Vault Operating Rules (All Agents)

> Rules for any LLM agent (Claude Code, Claude Desktop, Codex, Gemini CLI, or other) reading or writing this vault.
> See [[CLAUDE]] for the Claude-specific framing of the same rules.
