...
## RIS Operational Readiness (2026-04-22)

**Authoritative roadmap:** [[09-Decisions/RIS_OPERATIONAL_READINESS_ROADMAP_v1.1]]

| Date | Decision | Context |
|------|----------|---------|
| 2026-04-10 | Phase 2 audit: 2 CONFIRMED, 3 PARTIAL, 1 MISSING | Cloud providers don't exist, scoring weights wrong |
| 2026-04-09 | Weighted composite + per-dim floor as canonical gate | Simple sum as diagnostic only |
| 2026-04-09 | Model swappability via OpenAICompatibleProvider base class | Config change, not code change |
| 2026-04-22 | Ollama Cloud is OpenAI-compatible, trivial subclass | `deepseek-v3.2:cloud` free but session-limited |
| 2026-04-22 | Gemini remains friend-default (explicit 1,500/day quota) | Ollama Cloud as secondary option |
| 2026-04-22 | Agent allocation: CC#1 + CC#2 + Codex for Phase 2A | Hermes deferred to WP7 |
