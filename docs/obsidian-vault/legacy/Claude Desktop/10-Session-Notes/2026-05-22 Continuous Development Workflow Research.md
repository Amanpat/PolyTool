...
date: 2026-05-22
status: in-progress
topics: [24-7-dev, autonomous-agents, claude-code-bg, orchestration, verification, research-gathering]
---
...
- [[Decision - Workflow Harness Refresh 2026-04]] — current workflow primitives this builds on
- [[Decision - Agent Parallelism Strategy for RIS Phase 2]] — Hermes constraints already decided
- [[2026-04-21 Workflow Harness Refresh]] — last major workflow session
- [[2026-04-10 RIS Phase 2 Audit Results]] — overclaim case study to defend against
- [[Hermes Agent - PolyTool Integration Setup Guide]] — Hermes-not-orchestrator decision
