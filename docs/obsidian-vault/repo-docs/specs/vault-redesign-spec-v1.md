...
references:
- '2026-05-23-session-research-captured-vault-redesign (C-004: file not yet exported
  from Claude Desktop)'
related:
- 'claude-memory/decisions/2026-05-23-chroma-vs-obsidian-rag (missing: decision doc
  not yet created)'
depends_on: []
source_zone: repo
mirror_of: docs/specs/vault-redesign-spec-v1.md
...
- [[CLAUDE]] — operating rules referenced in this spec
```
...
- [[CLAUDE]] — Operating rules (Claude)
- [[AGENTS]] — Operating rules (any agent)

## Recent Activity

See [[log]] for chronological log.
...
- [[CLAUDE]] — operating rules this spec defines
- [[AGENTS]] — same rules, framed for non-Claude agents
- [[index]] — vault index, references this as the primary spec
