...
source_quality_caution: Practitioner guidance derived from LEARNINGS.md and contributor
  notes in the hermes-pmxt repo snapshot. Attribute claims to that source, not to
  official pmxt documentation. Behavior may differ across pmxt versions.
source_zone: repo
mirror_of: docs/external_knowledge/pmxt_sdk_operational_gotchas.md
