...
source_quality_caution: Derived from secondary packet references and indirect Kalshi
  documentation summaries. Verify exact fee formula, rounding semantics, fee-waiver
  fields, and maker/taker treatment against official Kalshi API docs or regulatory
  filings before treating as definitive.
source_zone: repo
mirror_of: docs/external_knowledge/kalshi_fee_structure_april2026.md
