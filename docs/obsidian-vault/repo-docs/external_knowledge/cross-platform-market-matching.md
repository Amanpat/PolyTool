...
source_quality_caution: Algorithm descriptions derive from secondary notes about matcher.js
  in the hermes-pmxt repo. No published benchmark, precision/recall study, or accuracy
  metric set was found. Keep confidence at COMMUNITY and treat the stated thresholds
  as starting-point heuristics, not validated defaults.
source_zone: repo
mirror_of: docs/external_knowledge/cross_platform_market_matching.md
