...
source_quality_caution: Derived from corrected internal notes and secondary packet
  references. Verify category fee rates, maker rebate split ratios, and /fee-rate
  endpoint behavior against primary Polymarket documentation before treating as definitive.
source_zone: repo
mirror_of: docs/external_knowledge/polymarket_fee_structure_april2026.md
