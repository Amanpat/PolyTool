---
title: Windows Development Gotchas
type: reference
status: active
source_zone: repo
mirror_of: docs/runbooks/WINDOWS_DEVELOPMENT_GOTCHAS.md
...
See also: [OPERATOR_SETUP_GUIDE.md](OPERATOR_SETUP_GUIDE.md), [OPERATOR_QUICKSTART.md](OPERATOR_QUICKSTART.md), [LIVE_DEPLOYMENT_STAGE1.md](LIVE_DEPLOYMENT_STAGE1.md)
...
- Live run prerequisites: [LIVE_DEPLOYMENT_STAGE1.md](LIVE_DEPLOYMENT_STAGE1.md)
