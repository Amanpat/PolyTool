...
status: active
source_zone: repo
mirror_of: docs/runbooks/OPERATOR_SETUP_GUIDE.md
...
See also: [OPERATOR_QUICKSTART.md](OPERATOR_QUICKSTART.md), [LIVE_DEPLOYMENT_STAGE1.md](LIVE_DEPLOYMENT_STAGE1.md), [WINDOWS_DEVELOPMENT_GOTCHAS.md](WINDOWS_DEVELOPMENT_GOTCHAS.md)
...
`docs/runbooks/OPERATOR_QUICKSTART.md` for the actual PolyTool command flow, and use
...
2. Log into a normal Windows user account that has Docker Desktop access.
   ...
   `docs/runbooks/WINDOWS_DEVELOPMENT_GOTCHAS.md` open during setup.
...
- Live trading prerequisites and daily review: [LIVE_DEPLOYMENT_STAGE1.md](LIVE_DEPLOYMENT_STAGE1.md)
