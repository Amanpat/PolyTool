---
title: "2026-04-27 — Academic Pipeline Diagnosis"
type: session_note
status: active
...
- [[claude-memory/work-packets/work-packet-academic-pipeline-pdf-download-fix]] — the actionable packet
- [[legacy/PolyTool/02-Modules/RIS]] — module status (currently flagged "done"; should be "partial" until this lands)
- [[legacy/PolyTool/05-Roadmap/Phase-2-Discovery-Engine]] — parent phase
- [[claude-memory/research/ris-operational-readiness-roadmap-v1]] — Phase 2A authoritative roadmap
