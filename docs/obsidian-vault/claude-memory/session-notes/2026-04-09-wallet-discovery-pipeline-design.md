---
title: "Wallet Discovery Pipeline — Complete Design Session"
type: session_note
status: active
...
1. LLM chunking approaches for large financial datasets → <!-- LEGACY: [[11-Prompt-Archive/2026-04-08 GLM5 - LLM Chunking]] -->
2. Strategy fingerprinting metrics for prediction markets → [[legacy/Claude Desktop/08-Research/02-Metrics-Engine-MVF]]
3. Insider trading detection in prediction markets → [[legacy/Claude Desktop/08-Research/03-Insider-Detection]]
4. Live wallet monitoring data sources (Alchemy, Goldsky, Subgraph) → [[claude-memory/prompts/2026-04-09-glm5-polymarket-event-volume]]
5. Polymarket leaderboard API → [[claude-memory/prompts/2026-04-09-glm5-polymarket-leaderboard-api]]
6. CLOB WebSocket subscription model + Alchemy CU costs → [[legacy/Claude Desktop/11-Prompt-Archive/2026-04-09 GLM5 - CLOB WebSocket and Alchemy CU]]
...
## Cross-References
- [[legacy/Claude Desktop/08-Research/01-Wallet-Discovery-Pipeline]]
- [[legacy/Claude Desktop/08-Research/02-Metrics-Engine-MVF]]
- [[legacy/Claude Desktop/08-Research/03-Insider-Detection]]
- [[legacy/Claude Desktop/08-Research/04-Loop-B-Live-Monitoring]]
- [[legacy/Claude Desktop/08-Research/05-LLM-Chunking-Strategy]]
- [[claude-memory/decisions/decision-two-feed-architecture]]
- [[claude-memory/decisions/decision-loop-a-leaderboard-api]]
- [[legacy/Claude Desktop/09-Decisions/Decision - Loop D Managed CLOB Subscription]]
