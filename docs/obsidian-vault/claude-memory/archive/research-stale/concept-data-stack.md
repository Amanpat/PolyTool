...
- [[legacy/PolyTool/01-Architecture/Database-Rules]] — ClickHouse/DuckDB one-sentence rule, all 23 tables
- [[legacy/PolyTool/01-Architecture/System-Overview]] — Layer roles and package structure
- [[legacy/PolyTool/01-Architecture/Tape-Tiers]] — Gold/Silver/Bronze tape definitions using these layers
