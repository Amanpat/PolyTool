---
title: "Issue: Dual Fee Calculation Modules"
type: reference
status: archived
...
- [[legacy/PolyTool/02-Modules/Core-Library]] — `fees.py` in core library
- [[legacy/PolyTool/02-Modules/SimTrader]] — `simtrader/portfolio/fees.py`
