...
Note: Two implementations exist — see [[legacy/PolyTool/07-Issues/Issue-Dual-Fee-Modules]] for the duplication risk.

---

## Cross-References

- [[legacy/PolyTool/02-Modules/Gates]] — Gate script inventory and details
- [[legacy/PolyTool/03-Strategies/Track-1B-Market-Maker]] — Market maker strategy validation path
- [[legacy/PolyTool/01-Architecture/System-Overview]] — System architecture overview
- [[legacy/PolyTool/07-Issues/Issue-Dual-Fee-Modules]] — Fee module duplication issue
