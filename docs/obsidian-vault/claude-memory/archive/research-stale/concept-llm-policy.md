...
- [[legacy/PolyTool/02-Modules/RAG]] — ChromaDB and KnowledgeStore serve as the backing knowledge store for LLM context
- [[legacy/PolyTool/02-Modules/RIS]] — RIS evaluation subpackage uses LLM providers from `packages/research/evaluation/providers.py`
- [[legacy/PolyTool/01-Architecture/System-Overview]] — LLM calls live in Python core layer, not FastAPI or CLI
