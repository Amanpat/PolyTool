...
- [[legacy/PolyTool/02-Modules/SimTrader]] — Uses tapes for replay, shadow, and sweep runs
- [[legacy/PolyTool/01-Architecture/Database-Rules]] — ClickHouse stores tape metadata, DuckDB reads Parquet
- [[legacy/PolyTool/01-Architecture/Risk-Framework]] — Gate 2 requires Silver tapes, Gate 3 requires Gold tapes
- [[legacy/PolyTool/01-Architecture/Data-Stack]] — Five free layers that produce tapes
