...
- [[legacy/PolyTool/01-Architecture/System-Overview]] — Layer roles
- [[legacy/PolyTool/02-Modules/SimTrader]] — SimTrader CLI detail
- [[legacy/PolyTool/02-Modules/RIS]] — Research Intelligence System CLI commands
- [[legacy/PolyTool/02-Modules/RAG]] — RAG CLI commands
- [[legacy/PolyTool/02-Modules/Gates]] — Gate scripts (not CLI-routed, run directly)
