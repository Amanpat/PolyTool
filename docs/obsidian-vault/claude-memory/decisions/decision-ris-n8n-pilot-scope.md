---
title: "Decision — RIS n8n Pilot Scope"
type: decision
status: superseded
...
See [[legacy/PolyTool/02-Modules/RIS]], [[legacy/PolyTool/05-Roadmap/Phase-3-Hybrid-RAG-Kalshi-n8n]], `docs/adr/0013-ris-n8n-pilot-scoped.md`

## Connections

- [[claude-memory/decisions/_index]]
- [[index|Vault Home]]
- [[repo-docs/adrs/adr-0013-ris-n8n-pilot-scoped]]
