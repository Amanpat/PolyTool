---
title: "Decision — Loop A Leaderboard Discovery via Data API"
type: decision
status: active
...
See [[claude-memory/prompts/2026-04-09-glm5-polymarket-leaderboard-api]], [[legacy/Claude Desktop/08-Research/01-Wallet-Discovery-Pipeline]]
