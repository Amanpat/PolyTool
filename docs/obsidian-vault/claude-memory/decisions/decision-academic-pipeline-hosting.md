---
title: "Decision — Academic Pipeline Hosting"
type: decision
status: active
...
- **Stay with pdfplumber as primary parser.** Rejected — operator confirmed quality matters, two-parser inconsistency is bad for embeddings. The architectural decision in [[legacy/Claude Desktop/09-Decisions/Decision - Scientific RAG Architecture Adoption]] is final on this.
...
- [[legacy/Claude Desktop/09-Decisions/Decision - Scientific RAG Architecture Adoption]] — establishes Marker as primary parser
- [[claude-memory/work-packets/work-packet-marker-structural-parser-integration]] — the packet this decision unblocks
- [[legacy/Claude Desktop/08-Research/11-Scientific-RAG-Target-Architecture]] — broader design context
- [[claude-memory/decisions/decision-ris-n8n-pilot-scope]] — current scheduler/n8n setup; this decision creates a split
