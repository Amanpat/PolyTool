---
title: "Decision — Workflow Harness Refresh 2026-04"
type: decision
status: active
...
- **Light RAG over `docs/`** — rejected. The existing [[legacy/PolyTool/02-Modules/RIS]] Chroma collection covers this use case and is partially built. Adding another half-built RAG would repeat the stalling pattern that motivated this refresh.
...
See [[legacy/PolyTool/02-Modules/RIS]], `docs/AGENTS.md`, `docs/CLAUDE.md`.
