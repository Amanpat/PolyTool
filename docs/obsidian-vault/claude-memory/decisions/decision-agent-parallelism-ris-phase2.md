---
title: "Decision — Agent Parallelism Strategy for RIS Phase 2"
type: decision
status: active
...
- For RIS Phase 2A (activates when Fee Model closes, fills Slot 3 per [[legacy/Claude Desktop/09-Decisions/RIS_OPERATIONAL_READINESS_ROADMAP]]):
...
> For RIS Phase 2A (WP1-WP5): use CC/Codex. For RIS Phase 2B (WP6 distributed workers): evaluate Hermes Agent (NousResearch) before building from scratch. See [[legacy/Claude Desktop/09-Decisions/Decision - Agent Parallelism Strategy for RIS Phase 2]].
...
- [[legacy/Claude Desktop/09-Decisions/RIS_OPERATIONAL_READINESS_ROADMAP]] — the roadmap this decision supports
- [[claude-memory/decisions/decision-workflow-harness-refresh-2026-04]] — parent framework
- [[claude-memory/decisions/decision-ris-n8n-pilot-scope]] — ADR 0013 (why n8n stays during Phase 2A)
- <!-- LEGACY: [[12-Ideas/Idea - Hermes Agent Platform Evaluation]] --> original Hermes evaluation, now superseded by this decision
- [[claude-memory/prompts/2026-04-21-architect-custom-instructions-v2]] — needs AGENT SELECTION addendum (see above)
