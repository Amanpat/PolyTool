---
title: "Work Packet: SimTrader Maker/Taker Fee Model + Kalshi Fee Model"
type: work_packet
status: active
...
> [!WARNING] SUPERSEDED
> This work packet has been replaced by [[claude-memory/work-packets/work-packet-unified-open-source-integration]].
> The fee model design was based on incorrect assumptions. See [[legacy/Claude Desktop/11-Prompt-Archive/2026-04-10 GLM5 - Unified Gap Fill Open Source Integration]] for corrections.
...
**Deep dive research note:** [[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]]
...
1. **Our current fee module:** `packages/polymarket/simtrader/portfolio/fees.py` (full contents provided in Codex output from 2026-04-10 session, also in [[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]])
...
- [[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]] — Full analysis of source repo
- [[legacy/PolyTool/02-Modules/SimTrader]] — SimTrader module documentation
- [[legacy/PolyTool/03-Strategies/Track-1A-Crypto-Pair-Bot]] — Maker rebate is core to pair bot economics
- [[legacy/PolyTool/03-Strategies/Track-1B-Market-Maker]] — Gate 2 results affected by taker-only fees
