---
title: "Work Packet — Marker Single-Paper Validation Control Surface"
type: work_packet
status: active
...
Completion of this packet unblocks resumption of <!-- LEGACY: [[claude-memory/work-packets/work-packet-marker-structural-parser-integration]] -->.
...
- [[Claude Desktop/12-Ideas/Work-Packet - Marker Structural Parser Integration]] — production rollout
  packet; this control surface unblocks its resumption
- [[claude-memory/decisions/decision-academic-pipeline-hosting]] — Docker GPU passthrough confirmed
