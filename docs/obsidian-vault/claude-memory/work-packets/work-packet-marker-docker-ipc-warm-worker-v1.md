---
title: "Work Packet — Marker Docker IPC Warm-Worker v1"
type: work_packet
status: active
...
6. [[claude-memory/work-packets/work-packet-marker-canonical-academic-parse-queue]] — v0 spec; acceptance gates 2 and 3 of that packet are the warm-throughput gates this packet satisfies
...
- [[claude-memory/work-packets/work-packet-marker-structural-parser-integration]] — L1 production rollout; BLOCKED pending this packet
- [[claude-memory/work-packets/work-packet-paperqa2-rag-control-flow]] — L2; explicitly blocked until warm-worker acceptance gates pass
- [[claude-memory/work-packets/work-packet-marker-canonical-academic-parse-queue]] — v0 that this packet extends (IPC warm-worker is the v1 deferred item)
- [[legacy/Claude Desktop/12-Ideas/Work-Packet - Marker Single-Paper Validation Control Surface]] — VALIDATED; cold-start timing evidence
- [[claude-memory/decisions/decision-academic-pipeline-hosting]] — Docker GPU passthrough confirmed; RTX 2070 Super; CUDA 13.2
