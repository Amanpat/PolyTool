---
title: "Work Packet — Academic Pipeline PDF Download Fix"
type: work_packet
status: active
...
Diagnosed from a Codex code-dump session on 2026-04-27 in the Claude Project. Full evidence trail in [[claude-memory/session-notes/2026-04-27-academic-pipeline-diagnosis]].
...
1. **The Codex code dump from 2026-04-27** — full bodies of `LiveAcademicFetcher`, `AcademicAdapter`, `PDFExtractor`, and the `research-acquire` CLI handler. Located in [[claude-memory/session-notes/2026-04-27-academic-pipeline-diagnosis]].
...
- [[legacy/PolyTool/02-Modules/RIS]] — module status, current behavior of evaluation/ingestion
- [[legacy/PolyTool/02-Modules/RAG]] — knowledge store integration point
- [[legacy/PolyTool/05-Roadmap/Phase-2-Discovery-Engine]] — parent phase
- [[claude-memory/research/ris-operational-readiness-roadmap-v1]] — authoritative Phase 2A roadmap
- [[legacy/Claude Desktop/09-Decisions/Decision - RIS Evaluation Scoring Policy]] — scoring weights affected by body content
- [[claude-memory/decisions/decision-ris-n8n-pilot-scope]] — n8n alerting surface for body_source field
- [[claude-memory/session-notes/2026-04-27-academic-pipeline-diagnosis]] — full Codex evidence dump (session note)
