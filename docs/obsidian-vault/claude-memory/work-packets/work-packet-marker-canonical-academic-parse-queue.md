---
title: "Work Packet — Marker Canonical Academic Parse Queue"
type: work_packet
status: active
...
6. [[legacy/Claude Desktop/12-Ideas/Work-Packet - Marker Single-Paper Validation Control Surface]] — `run-academic-url`; warm-vs-cold timing evidence
...
- [[claude-memory/work-packets/work-packet-paperqa2-rag-control-flow]] — L2; gated on this packet shipping
- [[claude-memory/decisions/decision-academic-pipeline-hosting]] — Docker GPU passthrough confirmed; RTX 2070 Super
- [[legacy/Claude Desktop/12-Ideas/Work-Packet - Marker Single-Paper Validation Control Surface]] — VALIDATED; control surface tooling
