---
title: "Unified Work Packet: Open-Source Integration Sprint"
type: work_packet
status: active
...
- [[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]] — Backtesting repo full analysis
- [[legacy/Claude Desktop/08-Research/08-Copy-Trader-Deep-Dive]] — Copy Trader analysis (low value, skip)
- [[legacy/Claude Desktop/08-Research/09-Hermes-PMXT-Deep-Dive]] — Hermes PMXT analysis
- [[legacy/Claude Desktop/11-Prompt-Archive/2026-04-10 GLM5 - Unified Gap Fill Open Source Integration]] — Research results
- [[legacy/PolyTool/02-Modules/SimTrader]] — SimTrader module docs
- [[legacy/PolyTool/03-Strategies/Track-1A-Crypto-Pair-Bot]] — Maker rebate impact
- [[legacy/PolyTool/03-Strategies/Track-1B-Market-Maker]] — Gate 2 pessimism from taker-only fees
- [[legacy/PolyTool/03-Strategies/Track-1C-Sports-Directional]] — Sports strategy foundations
- [[legacy/PolyTool/01-Architecture/Risk-Framework]] — Gate definitions reference net PnL after fees
- [[claude-memory/ideas/idea-pmxt-sidecar-architecture-evaluation]] — Parked decision
- [[legacy/Claude Desktop/12-Ideas/Idea - Cross-Platform Price Divergence as RIS Signal]] — Phase 3+ idea
