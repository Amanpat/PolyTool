---
title: "Deep Dive: realfishsam Repos (Copy Trader + Risk-Free Bot)"
type: research
status: active
...
- [[legacy/Claude Desktop/08-Research/01-Wallet-Discovery-Pipeline]] — Our 4-loop architecture (vastly superior to Copy Trader)
- [[legacy/PolyTool/02-Modules/Core-Library]] — arb.py and SimTrader BinaryComplementArb already exist
- [[legacy/PolyTool/02-Modules/SimTrader]] — CopyWalletReplay strategy already exists
- [[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]] — Backtesting repo (higher value than these)
- [[legacy/PolyTool/03-Strategies/Track-1A-Crypto-Pair-Bot]] — Uses custom clob_stream.py, not pmxt
