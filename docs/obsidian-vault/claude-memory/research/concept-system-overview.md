...
type: concept
status: superseded
superseded_by: repo-docs/overview.md
...
- [[legacy/PolyTool/01-Architecture/Database-Rules]] — ClickHouse + DuckDB separation rule, all 23 tables
- [[legacy/PolyTool/01-Architecture/Data-Stack]] — Five free data layers
- [[legacy/PolyTool/01-Architecture/Tape-Tiers]] — Gold / Silver / Bronze tape definitions
- [[legacy/PolyTool/01-Architecture/Risk-Framework]] — Validation ladder, gate definitions, capital stages
- [[legacy/PolyTool/02-Modules/Core-Library]] — Top-level module inventory
- [[legacy/PolyTool/02-Modules/SimTrader]] — Simulation engine details
- [[legacy/PolyTool/02-Modules/RAG]] — Retrieval-augmented generation architecture
- [[legacy/PolyTool/02-Modules/RIS]] — Research Intelligence System
- [[legacy/PolyTool/02-Modules/Gates]] — Gate management scripts
- [[legacy/PolyTool/02-Modules/FastAPI-Service]] — FastAPI service details
