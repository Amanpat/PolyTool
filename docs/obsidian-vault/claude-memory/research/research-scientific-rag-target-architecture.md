---
title: "11 — Scientific RAG Target Architecture"
type: research
status: active
...
The target-state design for the RIS academic pipeline, synthesized from the GLM-5 survey's "concrete combination" and locked in by [[legacy/Claude Desktop/09-Decisions/Decision - Scientific RAG Architecture Adoption]]. Layer 0 has shipped. Layer 1 scaffold is implemented as an experimental opt-in. Layers 2–4 are future packets. Each layer is a separate work packet built in order.

Full survey backing this design: [[legacy/Claude Desktop/08-Research/11-Scientific-RAG-Pipeline-Survey]].
...
**Status:** shipped 2026-04-27. See [[claude-memory/work-packets/work-packet-academic-pipeline-pdf-download-fix]] (status: shipped).
...
**Status:** scaffold implemented 2026-04-27 — experimental opt-in, production rollout deferred. See [[claude-memory/work-packets/work-packet-marker-structural-parser-integration]] and `docs/features/ris-marker-structural-parser-scaffold.md`.
...
**Status:** future packet (see [[claude-memory/work-packets/work-packet-paperqa2-rag-control-flow]]).
...
**Status:** future packet (see [[claude-memory/work-packets/work-packet-pre-fetch-svm-topic-filter]]).
...
**Status:** future packet (see [[claude-memory/work-packets/work-packet-multi-source-academic-harvesters]]).
...
- [[legacy/Claude Desktop/09-Decisions/Decision - Scientific RAG Architecture Adoption]] — the operational decision behind this design
- [[legacy/Claude Desktop/08-Research/11-Scientific-RAG-Pipeline-Survey]] — the survey that informed the design
- [[claude-memory/work-packets/work-packet-academic-pipeline-pdf-download-fix]] — Layer 0 packet (shipped 2026-04-27)
- [[claude-memory/work-packets/work-packet-marker-structural-parser-integration]] — Layer 1 packet (scaffold implemented, production deferred)
- [[claude-memory/work-packets/work-packet-paperqa2-rag-control-flow]] — Layer 2 packet (stub)
- [[claude-memory/work-packets/work-packet-pre-fetch-svm-topic-filter]] — Layer 3 packet (stub)
- [[claude-memory/work-packets/work-packet-multi-source-academic-harvesters]] — Layer 4 packet (stub)
- [[claude-memory/work-packets/work-packet-scientific-rag-evaluation-benchmark]] — evaluation packet (stub)
- [[claude-memory/session-notes/2026-04-27-academic-pipeline-diagnosis]] — bug that triggered this architecture
- [[legacy/PolyTool/02-Modules/RIS]] — current module
- [[legacy/PolyTool/02-Modules/RAG]] — current module
