---
title: "Deep Dive: realfishsam/Polymarket-Copy-Trader"
type: research
status: active
...
This repo is a minimal wrapper (~200 lines estimated) around pmxt's Python API. It polls target wallets, detects position changes, and mirrors trades with configurable sizing. Our existing 4-loop wallet monitoring architecture ([[legacy/Claude Desktop/08-Research/01-Wallet-Discovery-Pipeline]]) is dramatically more sophisticated. The Copy Trader adds almost nothing we haven't already designed.
...
From our own research in [[legacy/Claude Desktop/08-Research/01-Wallet-Discovery-Pipeline]]:
...
- [[legacy/Claude Desktop/08-Research/01-Wallet-Discovery-Pipeline]] — Our existing 4-loop wallet monitoring design (far ahead of Copy Trader)
- [[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]] — Other pmxt showcase project analysis
- [[legacy/PolyTool/03-Strategies/Track-1A-Crypto-Pair-Bot]] — Uses py-clob-client directly, not pmxt
