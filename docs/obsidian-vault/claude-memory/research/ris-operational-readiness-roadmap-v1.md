---
title: "RIS Operational Readiness — Updated Roadmap"
type: reference
status: superseded
...
> This document's body plus three appended updates contain contradictions that were resolved on 2026-04-22 evening. The authoritative version is [[claude-memory/research/ris-operational-readiness-roadmap-v1]]. This file is retained as historical record of the planning evolution but should NOT be used for implementation.
>
...
Per [[legacy/Claude Desktop/09-Decisions/Decision - RIS Evaluation Scoring Policy]].
...
Implementation reference: [[legacy/Claude Desktop/11-Prompt-Archive/2026-04-09 GLM5 - Gemini Flash Structured Evaluation]].
...
## Cross-References
- [[legacy/Claude Desktop/10-Session-Notes/2026-04-10 RIS Phase 2 Audit Results]] — audit findings
- [[legacy/Claude Desktop/09-Decisions/Decision - RIS Evaluation Gate Model Swappability]] — provider architecture
- [[legacy/Claude Desktop/09-Decisions/Decision - RIS Evaluation Scoring Policy]] — scoring weights and thresholds
- [[claude-memory/decisions/decision-ris-n8n-pilot-scope]] — n8n boundary (ADR 0013)
- [[claude-memory/decisions/decision-workflow-harness-refresh-2026-04]] — WIP limits, CURRENT_DEVELOPMENT.md
- [[claude-memory/work-packets/work-packet-unified-open-source-integration]] — fee model + RIS seeding
- [[legacy/Claude Desktop/11-Prompt-Archive/2026-04-09 GLM5 - Gemini Flash Structured Evaluation]]
- [[legacy/Claude Desktop/11-Prompt-Archive/2026-04-09 GLM5 - n8n ClickHouse Grafana Metrics]]
- [[legacy/Claude Desktop/11-Prompt-Archive/2026-04-09 GLM5 - RAG Retrieval Quality Testing]]
...
Director decided during the 2026-04-22 Hermes session to adopt Hermes Agent for Phase 2B distributed workers. Full setup guide at [[legacy/Claude Desktop/08-Research/Hermes Agent - PolyTool Integration Setup Guide]]. This update folds Hermes into the roadmap's Phase 2B and adjusts Phase 2A WP2 accordingly.
...
Independent track documented in [[legacy/Claude Desktop/08-Research/Hermes Agent - PolyTool Integration Setup Guide]]. Gives operator read-only Discord/Telegram access to PolyTool state. Can ship before, alongside, or after Phase 2B. Not a dependency.
...
- **Architect custom instructions:** Add the 2-line awareness for Phase 2B Hermes evaluation (see [[legacy/Claude Desktop/09-Decisions/Decision - Agent Parallelism Strategy for RIS Phase 2]]).
...
- [[legacy/Claude Desktop/08-Research/Hermes Agent - PolyTool Integration Setup Guide]] — full Phase 2B setup guide
- [[legacy/Claude Desktop/09-Decisions/Decision - Agent Parallelism Strategy for RIS Phase 2]] — parent decision (Hermes sequenced to Phase 2B, not Phase 2A)
- <!-- LEGACY: [[12-Ideas/Idea - Hermes Agent Platform Evaluation]] --> original Hermes evaluation (partially superseded by the setup guide)

## Connections

- [[claude-memory/research/_index]]
- [[index|Vault Home]]
- <!-- LEGACY: [[07-RIS-Phase2-Gap-Closure-Roadmap (2026-04-10 version)]] -->
- [[claude-memory/research/ris-operational-readiness-roadmap-v1.1]]
