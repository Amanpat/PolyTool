---
title: "RIS Operational Readiness — Consolidated Roadmap v1.1"
type: reference
status: active
...
version: 1.1
supersedes: claude-memory/research/ris-operational-readiness-roadmap-v1
---
...
Full setup in [[legacy/Claude Desktop/08-Research/Hermes Agent - PolyTool Integration Setup Guide]] under "Track 1: Operator Hermes Instance" section.
...
If triggered: wrap the same `polytool-ris-contribute` logic in a Hermes skill that runs on a schedule. Same output format (JSON in GitHub branch). Operator's import CLI works unchanged. Full setup guide already exists in [[legacy/Claude Desktop/08-Research/Hermes Agent - PolyTool Integration Setup Guide]].
...
Per [[legacy/Claude Desktop/09-Decisions/Decision - Agent Parallelism Strategy for RIS Phase 2]].
...
- [[legacy/Claude Desktop/09-Decisions/RIS_OPERATIONAL_READINESS_ROADMAP]] — original roadmap (superseded by this document)
- [[legacy/Claude Desktop/08-Research/Hermes Agent - PolyTool Integration Setup Guide]] — reference for optional operator Hermes instance and deferred WP7
- [[legacy/Claude Desktop/09-Decisions/Decision - Agent Parallelism Strategy for RIS Phase 2]] — agent allocation and Hermes sequencing
...
- [[claude-memory/decisions/decision-ris-n8n-pilot-scope]] — ADR 0013
...
- [[claude-memory/prompts/2026-04-21-architect-custom-instructions-v2]]
...
- [[index|Vault Home]]
- [[claude-memory/research/ris-operational-readiness-roadmap-v1]]
