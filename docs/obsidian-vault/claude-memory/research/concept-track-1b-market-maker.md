---
title: "Track 1B — Market Maker"
type: concept
status: superseded
superseded_by: repo-docs/specs/spec-0010-simtrader-vision-and-roadmap.md
...
- Escalation deadline for benchmark_v2 consideration: **2026-04-12 (PASSED — no decision recorded)**
- **Fee Model Overhaul (Deliverable A) shipped 2026-04-21.** Gate 2 Option 4 (re-run with corrected maker/taker + category-specific fees) is now unblocked. Director decision required.
...
- [[legacy/PolyTool/01-Architecture/Risk-Framework]] — Gate definitions, capital progression, validation ladder
- [[legacy/PolyTool/02-Modules/Gates]] — Gate management scripts and current status
- [[legacy/PolyTool/02-Modules/SimTrader]] — Simulation engine that validates the strategy
- [[legacy/PolyTool/05-Roadmap/Phase-1B-Market-Maker-Gates]] — Phase checklist detail
