---
title: "Deep Dive: 0xharryriddle/hermes-pmxt"
type: research
status: active
...
- **[[claude-memory/ideas/idea-pmxt-sidecar-architecture-evaluation]]** — All hermes-pmxt value is contingent on the pmxt sidecar decision. If we skip pmxt, we'd reimplement the Jaccard matching ourselves.
- **[[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]]** — Backtesting repo also uses pmxt for data but through NautilusTrader adapter layer
- **[[legacy/Claude Desktop/12-Ideas/Work-Packet - Fee Model Maker-Taker + Kalshi]]** — Kalshi fee model is needed regardless of whether we use pmxt or build our own adapter
...
- [[legacy/Claude Desktop/08-Research/08-Copy-Trader-Deep-Dive]] — Same pmxt SDK, different application
- [[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]] — Same pmxt ecosystem
- [[legacy/Claude Desktop/08-Research/01-Wallet-Discovery-Pipeline]] — Loop D uses CLOB WebSocket, not pmxt
- [[claude-memory/ideas/idea-pmxt-sidecar-architecture-evaluation]] — Gating question for all pmxt-dependent work
