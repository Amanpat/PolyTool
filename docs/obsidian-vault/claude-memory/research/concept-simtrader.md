...
- [[legacy/PolyTool/03-Strategies/Track-1B-Market-Maker]] — Uses SimTrader for validation
- [[legacy/PolyTool/01-Architecture/Risk-Framework]] — Gate definitions and capital progression
- [[legacy/PolyTool/01-Architecture/Tape-Tiers]] — Gold, Silver, Bronze tapes that SimTrader replays
- [[legacy/PolyTool/02-Modules/Gates]] — Gate scripts that run SimTrader sweeps
