---
title: "Phase 1B — Track 1: Market Maker (Gate Closure → Live)"
type: reference
status: superseded
superseded_by: repo-docs/specs/spec-phase1b-gate2-shadow-packet.md
...
- Escalation deadline for benchmark_v2 consideration: **2026-04-12 (PASSED — no decision recorded)**. See `docs/dev_logs/2026-04-15_gate2_decision_packet.md` for Options 1–4.
- **Fee Model Overhaul (Deliverable A) shipped 2026-04-21.** Gate 2 Option 4 (re-run with corrected maker/taker + category-specific fees) is now unblocked. Director decision required before any Gate 2 re-run.

---

## Cross-References

- [[legacy/PolyTool/03-Strategies/Track-1B-Market-Maker]] — Strategy description and gate detail
- [[legacy/PolyTool/02-Modules/Gates]] — Gate scripts and current status
- [[legacy/PolyTool/02-Modules/SimTrader]] — Simulation engine
- [[legacy/PolyTool/02-Modules/Market-Selection]] — 7-factor scorer
- [[legacy/PolyTool/01-Architecture/Tape-Tiers]] — Silver tape generation is the next unblock
