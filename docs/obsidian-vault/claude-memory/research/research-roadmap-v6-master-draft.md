---
title: "Roadmap v6.0 — Master Draft (Awaiting Promotion to Zone A)"
type: research
status: active
...
> **This is a draft for Aman's review.** Once approved, Claude Code installs the content below (everything under the "BEGIN MASTER" marker) at `PolyTool/05-Roadmap/00-MASTER.md`. See the decision record [[legacy/Claude Desktop/09-Decisions/Decision - Roadmap v6.0 Slim Master Restructure]] for context and installation steps.
...
| RIS (Research Intelligence System) | Implemented, near-operational — see [[claude-memory/research/ris-operational-readiness-roadmap-v1]] |
| Wallet Intelligence (four-loop) | v1 scope narrowed to Loop A + watchlist + unified scan + MVF only — see [[legacy/Claude Desktop/08-Research/06-Wallet-Discovery-Roadmap]] |
...
|-------|----------|---------|-----------------|--------|
| **1A — Crypto Directional** | Asymmetric directional with partial hedge on 5m/15m BTC/ETH/SOL markets. Maker rebates via limit orders. (Not the original snapshot pair accumulation thesis — that was invalidated by on-chain wallet analysis.) | $50–200 to start | Shortest | [[legacy/PolyTool/05-Roadmap/Phase-1A-Crypto-Pair-Bot]] |
| **1B — Market Maker** | Avellaneda-Stoikov two-sided quoting on longer-duration event markets. Spread capture + Polymarket liquidity rewards. | $500+ for meaningful returns | Longest — requires tape library, calibration, shadow validation | [[legacy/PolyTool/05-Roadmap/Phase-1B-Market-Maker-Gates]] |
| **1C — Sports Directional** | Logistic regression on freely available NBA data, fuzzy market matching, paper predictions tracked for ≥2 weeks before capital. | $200+ for diversified positions | Medium | [[legacy/PolyTool/05-Roadmap/Phase-1C-Sports-Model]] |
...
|-------|-------|--------|------|
| 0 | Accounts, wallet architecture, CLAUDE.md | In progress | [[legacy/PolyTool/05-Roadmap/Phase-0-Accounts-Setup]] |
| 1A | Track 2 — Crypto Directional | Active | [[legacy/PolyTool/05-Roadmap/Phase-1A-Crypto-Pair-Bot]] |
| 1B | Track 1 — Market Maker → Gate closure → Stage 1 | Active (Gate 2 blocked) | [[legacy/PolyTool/05-Roadmap/Phase-1B-Market-Maker-Gates]] |
| 1C | Track 3 — Sports Directional Model | Next active target | [[legacy/PolyTool/05-Roadmap/Phase-1C-Sports-Model]] |
| 2 | Discovery Engine + Research Scraper (incorporates RIS + Wallet Intelligence v1) | Partially shipped | [[legacy/PolyTool/05-Roadmap/Phase-2-Discovery-Engine]] |
| 3 | Hybrid RAG + Kalshi + n8n | Scoped, not started | [[legacy/PolyTool/05-Roadmap/Phase-3-Hybrid-RAG-Kalshi-n8n]] |
| 4 | Autoresearch parameter loop | Scoped, not started | [[legacy/PolyTool/05-Roadmap/Phase-4-Autoresearch]] |
| 5 | Advanced strategies (resolution arb, favorite-longshot, combinatorial) | Scoped | [[legacy/PolyTool/05-Roadmap/Phase-5-Advanced-Strategies]] |
| 6 | Closed-loop feedback + code-level autoresearch | Scoped | [[legacy/PolyTool/05-Roadmap/Phase-6-Closed-Loop]] |
| 7 | Unified UI (Studio rebuild — post-profit only) | Deferred | [[legacy/PolyTool/05-Roadmap/Phase-7-Unified-UI]] |
| 8 | Scale + universal platform abstraction | Deferred | [[legacy/PolyTool/05-Roadmap/Phase-8-Scale-Platform]] |
...
| System | Role | Detail |
|--------|------|--------|
| **Research Intelligence System (RIS)** | Four-layer knowledge accumulation: ingestion → evaluation gate → knowledge store → synthesis. Makes research queryable before code is written. | [[claude-memory/research/ris-operational-readiness-roadmap-v1]] |
| **Wallet Intelligence Pipeline** | Four loops — A (leaderboard discovery), B (live watchlist), C (deep analysis), D (anomaly detection). v1 scope narrowed. | [[legacy/Claude Desktop/08-Research/01-Wallet-Discovery-Pipeline]], [[legacy/Claude Desktop/08-Research/06-Wallet-Discovery-Roadmap]] |
...
| **Data Stack (ClickHouse + DuckDB)** | One rule: ClickHouse for live streaming writes, DuckDB for historical Parquet reads. They never share data. | <!-- LEGACY: [[01-Architecture]] --> |
| **Tape Library (Gold / Silver / Bronze)** | Gold = live-recorded tick. Silver = reconstructed from pmxt + Jon-Becker. Bronze = trade-level only. | <!-- LEGACY: [[01-Architecture]] --> |
...
Detail: <!-- LEGACY: [[01-Architecture]] --> and each phase file.
...
Open-source integration notes: [[legacy/Claude Desktop/08-Research/07-Backtesting-Repo-Deep-Dive]], [[legacy/Claude Desktop/08-Research/09-Hermes-PMXT-Deep-Dive]].
