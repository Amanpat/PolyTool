---
title: "Deep Dive: evan-kolberg/prediction-market-backtesting"
type: research
status: active
...
- [[legacy/PolyTool/02-Modules/SimTrader]] — Our existing simulation engine (comparison target)
- [[legacy/PolyTool/01-Architecture/Tape-Tiers]] — Gold/Silver/Bronze tier definitions
- [[legacy/PolyTool/03-Strategies/Track-1B-Market-Maker]] — Gate 2 failed on Silver tapes — relay service could help
- [[legacy/PolyTool/03-Strategies/Track-1C-Sports-Directional]] — Their sports strategies are direct inputs
- [[legacy/PolyTool/05-Roadmap/Phase-1A-Crypto-Pair-Bot]] — No overlap with this repo
...
- [[legacy/PolyTool/02-Modules/SimTrader]] — Fill engine comparison details
- [[legacy/PolyTool/03-Strategies/Track-1A-Crypto-Pair-Bot]] — Maker rebate not modeled in fees
- [[legacy/PolyTool/03-Strategies/Track-1B-Market-Maker]] — Gate 2 results may be pessimistic due to taker-only fee model
- [[legacy/PolyTool/03-Strategies/Track-1C-Sports-Directional]] — Sports strategy extraction targets
