---
title: "Hermes Agent — PolyTool Integration Setup Guide"
type: reference
status: active
...
Per [[legacy/Claude Desktop/09-Decisions/RIS_OPERATIONAL_READINESS_ROADMAP]] Phase 2B, friend machines run lightweight RIS workers that fetch, evaluate, and sync documents back. The original roadmap (WP6-A/B/C/D) assumed building a custom `polytool-ris-worker` Python package from scratch.
...
- [[legacy/Claude Desktop/09-Decisions/RIS_OPERATIONAL_READINESS_ROADMAP]] — Phase 2B WPs being replaced/simplified by this guide
- [[legacy/Claude Desktop/09-Decisions/Decision - Agent Parallelism Strategy for RIS Phase 2]] — parent decision record (updated 2026-04-22)
- <!-- LEGACY: [[12-Ideas/Idea - Hermes Agent Platform Evaluation]] --> original Hermes evaluation (partially superseded)
- [[claude-memory/decisions/decision-workflow-harness-refresh-2026-04]] — governance framework
- [[claude-memory/decisions/decision-ris-n8n-pilot-scope]] — ADR 0013 (why n8n stays for Phase 2A)
...
### Cross-References
- [[legacy/Claude Desktop/08-Research/Hermes Agent - PolyTool Integration Setup Guide]] — parent doc
- [[legacy/Claude Desktop/09-Decisions/RIS_OPERATIONAL_READINESS_ROADMAP]] — Phase 2B placement
...
### Cross-References
- [[legacy/Claude Desktop/09-Decisions/RIS_OPERATIONAL_READINESS_ROADMAP]] — parent roadmap (2026-04-22 Late update applies; this further revises Phase 2B)
- [[legacy/Claude Desktop/09-Decisions/Decision - Agent Parallelism Strategy for RIS Phase 2]] — Hermes sequencing
