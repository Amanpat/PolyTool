...
- [[legacy/PolyTool/03-Strategies/Track-1B-Market-Maker]] — Gate status and validation path
- [[legacy/PolyTool/02-Modules/SimTrader]] — Replay runner used by Gate 1 and Gate 2
- [[legacy/PolyTool/01-Architecture/Tape-Tiers]] — Silver tapes consumed by Gate 2 sweep
- [[legacy/PolyTool/02-Modules/Notifications]] — Gate scripts fire Discord alerts via notify_gate_result
