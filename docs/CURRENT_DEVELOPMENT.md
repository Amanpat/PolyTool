...
| ------------------------------------------------------------- | ---------- | -------- | ------------------------------------------------------------------ |
| RIS L4 Multi-source Academic Harvesters                      | 2026-05-09 | RIS      | `docs/features/FEATURE-ris-l4-multisource-academic-harvesters.md` — 4 harvesters (arXiv, Semantic Scholar, Crossref, OpenReview); `AcademicCandidate` dataclass; `dedup_candidates()` by canonical_id; `research-harvest` CLI; `SOURCE_CAPABILITY_MATRIX` with SSRN/NBER deferred; 59 tests pass; L3 scoring integrated. Dev log: `docs/dev_logs/2026-05-09_ris-l4-multisource-academic-harvesters.md`. |
