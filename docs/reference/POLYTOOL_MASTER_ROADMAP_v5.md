...
**Version:** 5.0 · **Date:** March 2026 · **Status:** Living Document
...
| `research` | Validated StrategySpecs, performance records, post-mortems | High / Curated | Gate pass + human confirmation |
...
- [ ] **Market Selection Engine**
      Scores all active markets every 2 hours. Factors: reward APR, spread,
      volume, competing MM count, age bonus, category weights from Jon-Becker.
...
- [ ] **Unified Chroma collection (`polytool_brain`)**
      ...
      tags. Write policy enforcement added at ingest time — `research` partition gate is
      programmatic, not a convention. Existing RAG queries continue to work via the same
      CLI commands, now pointing at the unified collection.
...
*End of PolyTool Master Roadmap — version 5.0 — March 2026*
*Living document. Update when architecture decisions are made or phases complete.*
*Supersedes v4.2. Reference v4.2 only for historical context.*
